...
Note: weather (including wind speed/direction) is read from Weather.csv as a global
weather period signal, not as a per-cell wind field in this experiment script.
